...
export enum ParaSwapContractMethod {
...
export enum ParaSwapPriceErrorMessage {
...
export interface ParaSwapPriceRouteWithError {
...
export interface ParaSwapOptimalRoute {
  /** @example 100 */
  percent: number;
...
export enum ParaSwapTransactionsErrorMessage {
 ...
 */
export type ParaSwapRouterParameters = (string | string[])[];
...
export interface ParaSwapTransactionsCreateParams {
