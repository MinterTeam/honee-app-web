...
export interface OneInchApproveSpenderResponseDto {
  /** Address of the 1inch router that must be trusted to spend funds for the exchange */
  address: string;
}

export interface OneInchApproveCalldataResponseDto {
...
export interface OneInchTokenDto {
  symbol: string;
  name: string;
  address: string;
  decimals: number;
...
export interface OneInchTokensResponseDto {
  /** List of supported tokens */
  tokens: OneInchTokenDto[];
}

export interface OneInchProtocolImageDto {
  /** Protocol id */
  id: string;
  /** Protocol title */
  title: string;
...
export interface OneInchQuoteResponseDto {
  /** Source token info */
...
export interface OneInchSwapErrorDto {
  /**
   * HTTP code
   * @example 400
   */
...
export interface OneInchSwapResponseDto {
  /** Source token info */
  fromToken: OneInchTokenDto;
  /** Destination token info */
  toToken: OneInchTokenDto;
