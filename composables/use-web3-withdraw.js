...
const props = reactive({
    ...
    destinationFee: {[HUB_WITHDRAW_SPEED.MIN]: 0, [HUB_WITHDRAW_SPEED.FAST]: 0},
...
const destinationFeeInCoin = computed(() => {
    ...
    const selectedDestinationFee = props.destinationFee[props.speed] || 0;
...
export default function useWeb3Withdraw(destinationAddress) {
    props.destinationAddress = destinationAddress;
