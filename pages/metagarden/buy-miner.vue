        ...
        <div class="card card--invert">
            <div class="card__content card__content--medium">
                ...
                <p class="card__action-description u-mt-05">
                    {{ $td(`You can buy from 0.1 miner. The cost of 0.1 miner is $8.`, 'metagarden.description', {priceUsd: $options.SPOT_PRICE_USD, priceMetagarden: $options.SPOT_PRICE_METAGARDEN}) }}
                </p>
            </div>
