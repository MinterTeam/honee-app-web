...
<template>
    <div class="u-section u-text-center topup__vertical-container u-container u-container--small">
        <div class="card card__content card__content--small topup__vertical-center">
            ...
            <nuxt-link class="button button--main button--full u-mt-10" :to="$i18nGetPreferredPath('/onboarding/topup/bsc')">
            ...
            <nuxt-link class="button button--main button--full u-mt-10" :to="$i18nGetPreferredPath('/onboarding/topup/ethereum')">
