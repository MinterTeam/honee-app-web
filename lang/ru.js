...
export default {
    ...
    meganet: {
        ...
        'early-adopter-title': 'Купить токены платформы',
        'early-adopter-description': 'Мы готовимся к запуску самого быстрого EVM блокчейна первого уровня, предназначенного для игр. Вы можете купить прелонч токены, чтобы присоединиться к нашему проекту.',
        ...
        'gaming-platform-title': 'О платформе',
        'gaming-platform-p': 'Попробуйте первые крипто-игры платформы Metagarden. Представленные игры находятся в альфа-статусе и в них можно играть с единого Telegram-бота.',
