...
export default {
    ...
    meganet: {
        ...
        'early-adopter-description': 'Все держатели токенов MEGANET получат монеты MEGA (нативные монеты Metagarden Chain) со 100% бонусом после запуска основной сети. Текущая цена MEGANET составляет',
