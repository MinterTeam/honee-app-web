export default {
    ...
    referral: {
        'invite-friend': 'Приглашай друзей — получай награды',
        'title': 'Зарабатывай с Honee',
        'description-activated': 'Приглашай друзей и получай 10% от их стейкинг наград. Скопируй ссылку ниже или из адресной строки твоего браузера на любой странице Honee App и поделись ею с друзьями.',
        ...
        'success-description': 'Скопируй ссылку из адресной строки твоего браузера на любой странице Honee App и поделись ею с друзьями.',
        'success-deactivate-title': 'Реферальная ссылка деактивирована',
        'success-deactivate-description': 'Реферальная ссылка в адресной строке отключена. Ты можешь активировать её вновь в любой момент.',
    },
    receive: {
    ...
    portfolio: {
        'manage-create-title': 'Создание портфолио',
        'manage-edit-title': 'Редактирование портфолио',
        ...
        'manage-confirm-create-title': 'Подтверждение создания портфолио',
        'manage-confirm-edit-title': 'Подтверждение редактирования портфолио',
        'manage-confirm-description': 'Короткое описание',
        'manage-success-created': 'Портфолио успешно создано!',
        'manage-success-edited': 'Портфолио успешно обновлено!',
        'manage-success-view': 'Смотреть портфолио',
        'buy-title': 'Купить портфолио',
        'buy-button': 'Купить',
        'my-list-title': 'Мои портфолио',
        'my-list-empty': 'У вас пока нет созданных портфолио',
        'create-new-link': 'Создать своё собственное портфолио',
    },
    action: {
