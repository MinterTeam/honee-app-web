export default {
    ...
    referral: {
        ...
        'description-activated': 'Приглашай друзей и получай 10% от их наград за стейкинг BEE. Скопируй ссылку ниже или из адресной строки твоего браузера на любой странице Honee App и поделись ею с друзьями.',
    ...
    portfolio: {
        ...
        'manage-success-view': 'Вам нужно быть Премиум пользователем или быть залогиненным через Telegram, чтобы создать портфель.',
        'manage-requirements-description': '',
        'head-copy-of': 'Копия',
        ...
        'tabs-label-recommend': 'Рекомендованные',
        'tabs-label-top': 'Топ',
        'tabs-label-all': 'Все',
