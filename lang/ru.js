...
export default {
    ...
    index: {
        ...
        'already-have-wallet-megachain': 'Войти с помощью сид-фразы',
    ...
    deposit: {
        ...
        'label-buy-with-eth': 'Отправьте ETH или USDT (ERC-20) на этот адрес',
        'label-buy-with-bnb': 'Отправьте BNB или USDT (BEP-20) на этот адрес',
    ...
    meganet: {
        ...
        'description': 'Присоединяйтесь к Metagarden Chain, мощному EVM-блокчейну, предназначенному для игр. Купите токены {coin} до запуска основной сети, чтобы получить бонус.',
        'buy-button': 'Купить токены {coin}',
        'buy-text': 'Купите токены {coin} любым из этих вариантов, чтобы присоединиться к Metagarden Chain.',
        'welcome-title': 'Добро пожаловать!',
        'welcome-description': 'Спасибо за активацию лаунчпада с лучшими крипто-играми в Telegram. В качестве приветственного бонуса мы хотели бы подарить вам $10 в цифровой валюте нашей платформы.',
        'welcome-grab-button': 'Получить $10',
        'welcome-grab-success': 'Отлично!',
        'welcome-join-group-button': 'Вступить в группу',
        'play-our-games': 'Играйте в наши игры',
        'early-adopter-title': 'Купить токены проекта',
        'early-adopter-description': 'Мы готовимся к запуску Metagarden Chain, самого быстрого EVM-блокчейна, предназначенного для игр, его вторая тестовая сеть работает отлично. Вы можете купить токены Metagarden Chain перед запуском, чтобы присоединиться к нашей экспансии крипто-игр в Telegram.',
        'early-adopter-description-price': ' Текущая цена {coin} составляет',
        ...
        'useful-links-button-influencer': 'Инфлюенсерам',
        ...
        'gaming-platform-videoid': 'rhEgn11amV4',
        'gaming-platform-title': 'Платформа',
        'gaming-platform-p': 'Попробуйте первые крипто-игры для Telegram. Они находятся в альфа-версии и в них можно играть с единого Telegram-бота.',
        'gaming-platform-button': 'Играть',
        'gaming-platform-p-small': 'Попробуйте α-версии наших игр в Telegram',
        'gaming-platform-more': 'Подробнее',
        'gaming-platform-more-url': 'https://metagarden.io/ru',
        'referral-program-title': 'Реферальная программа',
        ...
        'farmers-card-description': 'Игры зарабатывают комиссии, NFT-боты их собирают и отправляют тебе. Первая лимитированная партия фармер-ботов уже в продаже.',
    },
    'mg-farming': {
        'offer-left': 'Фармеров осталось: {left}',
        'buy-block-title': 'NFT фармер-бот',
        'buy-block-description': 'Стоит $100 и добывает $200 в течение 6-18 месяцев в зависимости от выбранной игры. Игры зарабатывают комиссии, NFT-боты их собирают и отправляют тебе.',
        'buy-block-button': 'Купить фармер-бота за $100',
        'buy-block-soon': 'Активация в ближайшее время',
        'about-farmers-title': 'Фармер-боты',
        'buy-options-title': 'Купить фармер-ботов',
        'buy-options-minter-title': 'Купить фармер-ботов в Minter',
        'buy-farmers-description': 'Стоимость 1 фармер-бота $100. Можно купить от 1 до 10 фармер-ботов.',
    },
    'mg-lootbox': {
        ...
        'new-lootbox-p': 'Проверяйте лаунчпад каждый день, чтобы не пропустить новые лутбоксы.',
        'no-lootbox-title': 'Лутбоксов нет. Зайдите завтра!',
        'no-lootbox-p': 'Проверяйте лаунчпад каждый день, чтобы не пропустить новые лутбоксы.',
    },
    'mg-games': {
