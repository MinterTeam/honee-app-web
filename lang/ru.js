...
export default {
    ...
    meganet: {
        ...
        'welcome-description': 'Спасибо что запустил лаунчпад с лучшими играми в телеграмме. Тут ты можешь получать бонусы от игр каждый день. В качестве бонуса мы дарим тебе $10, нового игрового блокчейна.',
        'early-adopter-title': 'Купите токены {coin}, чтобы получить бонус и аирдропы от игр',
        'early-adopter-description': 'Все держатели токенов {coin} получат монеты MEGA (нативные монеты Metagarden Chain) с бонусом после запуска основной сети.',
